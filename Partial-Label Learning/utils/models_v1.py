...
class MetaLinear(MetaModule):
    def __init__(self, in_features, out_features, bias, *args, **kwargs):
        super().__init__()
        ignore = nn.Linear(in_features, out_features, bias, *args, **kwargs)
...
class mlp(MetaModule):
    def __init__(self, n_inputs, n_outputs, parameter_momentum=0.1):
        ...
        self.L1 = MetaLinear(n_inputs, 300, bias=False)
        init.xavier_uniform_(self.L1.weight)
        self.bn1 = MetaBatchNorm1d(300, momentum=parameter_momentum)
        init.ones_(self.bn1.weight)

        self.L2 = MetaLinear(300, 301, bias=False)
        init.xavier_uniform_(self.L2.weight)
        self.bn2 = MetaBatchNorm1d(301, momentum=parameter_momentum)
        init.ones_(self.bn2.weight)

        self.L3 = MetaLinear(301, 302, bias=False)
        init.xavier_uniform_(self.L3.weight)
        self.bn3 = MetaBatchNorm1d(302, momentum=parameter_momentum)
        init.ones_(self.bn3.weight)

        self.L4 = MetaLinear(302, 303, bias=False)
        init.xavier_uniform_(self.L4.weight)
        self.bn4 = MetaBatchNorm1d(303, momentum=parameter_momentum)
        init.ones_(self.bn4.weight)

        self.L5 = MetaLinear(303, n_outputs, bias=True)
