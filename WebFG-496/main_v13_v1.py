...
def main():
    ...
    if step == 1:
        ...
        vnet = ACVNet(1, 100, 100, 1, 1).cuda()
    ...
    if step == 2:
        cot.load_state_dict(torch.load('model/v13_v1_aircraft_net_step1_vgg16_best_epoch.pth'))
    ...
    for epoch in range(start_epoch, num_epochs):
        ...
        if test_acc > best_accuracy:
            ...
            best_epoch = epoch + 1
            torch.save(cot.state_dict(), 'model/v13_v1_aircraft_net_step{}_vgg16_best_epoch.pth'.format(step))
            torch.save(vnet.state_dict(), 'model/v13_v1_aircraft_vnet_step{}_vgg16_best_epoch.pth'.format(step))
